...
~function (doc,win,$) {
    var URL = '/ajax';
    var inputUser = document.getElementsByName('username')[0];
    var inputPass = document.getElementsByName('password')[0];
    var inputRand = document.getElementsByName('randnumber')[0];
    ...
    $('#btn-submit').click(function () {
        ...
        $.get(
            URL,
            {act:'login',username:user,randnumber:inputRand.value,
